...
interface XenditBankPort
{
    ...
    public function createPayout(string $referenceId, int $amount, string $bankCode, string $accountNumber, string $accountHolderName, string $userEmail, string $description = 'Pembayaran gaji tutor'): array;
}
