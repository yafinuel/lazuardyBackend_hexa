...
class VerifyOtpAction
{
    ...
    public function execute(string $code, string $identifier, OtpIdentifierEnum $identifierType, OtpVerificationTypeEnum $verificationType): ?string
    {
        ...
        if ($verificationType == OtpVerificationTypeEnum::FORGOT_PASSWORD) {
